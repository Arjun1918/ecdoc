import 'package:ecdoc/core/storage/share_pref/userdata_model.dart';
...
class SharedPref {
  ...
  Future<void> storeAccessToken(String? accessToken, String? doctorId, String? doctorEmail) async {
    await _initSharedPreferences();
    if (accessToken != null && doctorId != null && doctorEmail != null) {
      await _prefs!.setString('accessToken', accessToken);
      await _prefs!.setString('doctorId', doctorId);
      await _prefs!.setString('doctorEmail', doctorEmail);
    }
  }
  ...
  Future<void> storeUserData(UserData userData) async {
    ...
    String doctorEmail = userData.doctorEmail;

    await storeAccessToken(accessToken, doctorId, doctorEmail);
    await storeRefreshToken(refreshToken);
    await storeUserId(doctorId);
  }
